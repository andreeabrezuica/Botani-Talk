#ifndef CONFIG_H
#define CONFIG_H
const uint8_t pump_pin = A5;

//const uint8_t moistureSensor_powerPin = 13;
const uint8_t moistureSensor_readPin = A2;
...
const int pump_downTime = 5000; /* wait 20 seconds even if still dry */
const int pump_activeDuration = 1000;
const int maxTimeWithoutWater = 30000; // 1 MIN
unsigned long timeSinceLastMail = 0;

const uint8_t light_readPin = A4;
